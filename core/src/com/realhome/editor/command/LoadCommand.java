...
public class LoadCommand extends Command {
	...
	public void execute (Object... params) {
		...
		floor.addWall(new Wall().setFloor(floor).setPoint0(0, 0).setPoint1(0, 200));
		floor.addWall(new Wall().setFloor(floor).setPoint0(0, 200).setPoint1(300, 300));
		floor.addWall(new Wall().setFloor(floor).setPoint0(300, 300).setPoint1(500, 300));
