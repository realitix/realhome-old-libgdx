...
public class ShapeRenderer implements Disposable {
	...
	public ShapeRenderer (int maxVertices, ShaderProgram defaultShader) {
		this(maxVertices, false, defaultShader);
	}

	public ShapeRenderer (int maxVertices, boolean normal, ShaderProgram defaultShader) {
		if (defaultShader == null) {
			renderer = new ImmediateModeRenderer20(maxVertices, false, true, 0);
		} else {
			renderer = new ImmediateModeRenderer20(maxVertices, normal, true, 0, defaultShader);
		}
