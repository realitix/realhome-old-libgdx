...
public class PbrShader2 extends DefaultShader{

	private String pbrFile = "d3/pbr/pbr";
	...
	public static class Setters extends DefaultShader.Setters {
		public final static Setter gbuffer0 = new LocalSetter() {
			...
			public void set (BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
				final int unit = shader.context.textureBinder.bind(combinedAttributes.get(MrtAttribute.class, Mrt.GBuffer0).textureDescription);
		...
		public final static Setter gbuffer1 = new LocalSetter() {
			@Override
			public void set (BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
				final int unit = shader.context.textureBinder.bind(combinedAttributes.get(MrtAttribute.class, Mrt.GBuffer1).textureDescription);
				shader.set(inputID, unit);
			}
		};
		public final static Setter gbuffer2 = new LocalSetter() {
			@Override
			public void set (BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
				final int unit = shader.context.textureBinder.bind(combinedAttributes.get(MrtAttribute.class, Mrt.GBuffer2).textureDescription);
				shader.set(inputID, unit);
			}
		};
		public final static Setter gbuffer3 = new LocalSetter() {
			@Override
			public void set (BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
				final int unit = shader.context.textureBinder.bind(combinedAttributes.get(MrtAttribute.class, Mrt.GBuffer3).textureDescription);
				shader.set(inputID, unit);
			}
		};
	...
	public PbrShader2 (final Renderable renderable) {
		this(renderable, new Config());
	}

	public PbrShader2 (final Renderable renderable, final Config config) {
		this(renderable, config, createPrefix(renderable, config));
	}

	public PbrShader2 (final Renderable renderable, final Config config, final String prefix) {
		this(renderable, config, RealShader.create(pbrFile, prefix));
	}

	public PbrShader2 (final Renderable renderable, final Config config, final ShaderProgram shaderProgram) {
