 ...
 * <p>
 * <P>
 * Your application must register <code>IProxy</code> instances with the <code>Model</code>. Typically, you use an
 * <code>ICommand</code> to create and register <code>IProxy</code> instances once the <code>Facade</code> has initialized the
 * Core actors.
 * </p>
 * 
...
public class CoreModel implements Model {
	 ...
	 * <p>
	 * <p>
	 * This <code>IModel</code> implementation is a Multiton, so you should not call the constructor directly, but instead call the
	 * static Multiton Factory method <code>Model.getInstance( multitonKey )</code>
	 * 
