 ...
 * <p>
 * <p>
 * An <code>Observer</code> is an object that encapsulates information about an interested object with a method that should be
 * called when a particular <code>INotification</code> is broadcast.
 * </P>
 * <p>
 * <p>
...
public class BaseObserver implements Observer {
	 ...
	 * <p>
	 * <p>
	 * The notification method on the interested object should take one parameter of type <code>INotification</code>
	 * </P>
	 * 
	...
	static public class BaseFunction implements Function {
		@Override
